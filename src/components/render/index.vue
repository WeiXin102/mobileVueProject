...
export default {
  ...
  render: function(createElement) {
    ...
    let _header = this.$slots.default; // $slots: vue中所有分发插槽，不具名的都在default里
    ...
    return createElement(
      ...
      [
        "text", // 文本节点直接写就可以
        this.$slots.default ,// 所有不具名插槽，是个数组
        createElement("div", this.$slots.default) // createElement()创建的VNodes
      ]
    );
  }
};
